...
# images
images=(
oraclejdk:1.8.192-centos,registry.cn-hangzhou.aliyuncs.com/rancococ/oraclejdk:1.8-centos
oraclejdk:1.8.192-centos,registry.cn-hangzhou.aliyuncs.com/rancococ/oraclejdk:1.8.192-centos
)
